...
namespace C.UI.Helpers
{
    public static class PagerHtmlHelper
    {
        ...
        private static TagBuilder Page(int i, IPagedList list, Func<int, string> generatePageUrl, PagedListRenderOptions options)
        {
            ...
            page.Attributes["class"] = "Page-Item";
        ...
        public static MvcHtmlString PagedListHtmlPager(this System.Web.Mvc.HtmlHelper html,
                                                   IPagedList list,
                                                   Func<int, string> generatePageUrl)
        {
            return PagedListHtmlPager(html, list, generatePageUrl, new PagedListRenderOptions());
        }
