...
{
    [RoutePrefix("api/FileUploadBanner")]
    public class FileUploadBannerController : ApiController
    {
        [HttpPost]
        public string Preview()
        {
            ...
            if (HttpContext.Current.Request.Files.AllKeys.Any())
            {
                ...
                if (httpPostedFile != null)
                {
                    ...
                    string folderUpload = Config.URL_UPLOAD_BANNER + DateTime.Now.Month + "_" + DateTime.Now.Year + "/";
